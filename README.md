...
<div align="center">
  <br>
  <img src="https://raw.githubusercontent.com/Bitte-ein-Git/ha_xbox-dev/master/img/logo%402x.png" alt="Logo" width="512">
  <br><br>

  <h1>🗿• Xbox Dev Mode 🛠️</br>
      Home Assistant Integration</h1>

`» Xbox Dev Mode Sensor Data`
...
## Installation (Easy)
[![ADD][hacs2]](https://ha-link.heyfordy.de/redirect/hacs_repository/?owner=Bitte-ein-Git&repository=ha_xbox-dev&category=integration)
## Installation (Manual)
1. Add this Repository to HACS:
   - HACS > 3 dots > "Add custom repository"
   - URL: `Bitte-ein-Git/ha_xbox-dev`
   - Type: Integration

2. Select "**Xbox Dev Mode 🛠️**".
